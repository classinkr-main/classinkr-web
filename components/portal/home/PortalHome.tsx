      ...
      <div className="p-4 space-y-6">
        ...
        <div>
          <div className="mb-3 flex items-center justify-between">
            ...
            <Link href={calendarHref} className="text-[10px] text-[#1a1a1a]/40 hover:text-[#1a1a1a]">
              전체 →
            </Link>
          </div>
              ...
              >
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Link href={resolvedLinkTargets.documents} onClick={e => e.stopPropagation()} className="text-xs text-[#1a1a1a]/40 hover:text-[#1a1a1a]">문서 →</Link>
                ...
                >
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2">
                      <Link href={resolvedLinkTargets.documents} onClick={e => e.stopPropagation()} className="text-xs text-[#1a1a1a]/40 hover:text-[#1a1a1a]">계약서 →</Link>
