...
const COMMANDS: Command[] = [
  ...
  { group: "성장", label: "자료 퍼널", href: "/admin/materials", keywords: "자료 퍼널 리드마그넷 material funnel download" },
  ...
  { group: "분석", label: "추적 현황", href: "/admin/analytics?tab=tracking", keywords: "tracking client events pixel 추적 계측" },
