...
// CRM 홈(작업대)과 Overview(요약)에서 공유하는 링 공용 시각화 — summary 모드는 헤더/CTA를 생략한다.
export interface CrmHealthDist {
  total: number
  safe: number
  watch: number
  risk: number
...
export default function CrmHealthDonut({ variant = "full" }: { variant?: "full" | "summary" }) {
