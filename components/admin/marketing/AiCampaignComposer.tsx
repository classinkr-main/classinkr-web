      ...
      <div className="bg-white rounded-xl border border-[#e8e8e4] p-6">
        <div className="flex items-center gap-2 mb-4">
          <div className="w-7 h-7 rounded-lg bg-[#D1FAE5] flex items-center justify-center">
            <Sparkles className="w-3.5 h-3.5 text-[#065c41]" />
          </div>
        ...
        <div className="space-y-4">
          ...
          <div>
            ...
            <textarea
              ...
              className="w-full px-3 py-2.5 border border-[#e8e8e4] rounded-lg text-[13px] text-[#111110] focus:outline-none focus:ring-2 focus:ring-[#084734]/20 focus:border-[#084734] resize-none placeholder:text-[#1a1a1a]/25 leading-relaxed"
            />
          </div>
          ...
          <div className="flex items-center gap-3">
            <Button
              ...
              variant="outline"
              size="sm"
              className="border-[#D1FAE5] text-[#065c41] hover:bg-[#ECFDF5]"
            >
            ...
            {hasPreview && allDone && (
              <Button
                ...
                size="sm"
                className="bg-[#084734] hover:bg-[#065c41] text-white"
              >
                {sending ? (
                  <>
                    <Loader2 className="w-3.5 h-3.5 mr-1.5 animate-spin" />
          ...
          {/* 발송 결과 */}
          {sendResult && (
            <div className="px-3 py-2 rounded-lg bg-[#ECFDF5] border border-[#D1FAE5] text-[13px] text-[#084734]">
              ✓ {sendResult}
            </div>
          )}
        </div>
      ...
      {previews.length > 0 && (
        <div>
          <p className="text-[12px] font-medium text-[#1a1a1a]/40 mb-3 flex items-center gap-2">
            <Sparkles className="w-3.5 h-3.5 text-[#084734]" />
  ...
  return (
    <div className="bg-white rounded-xl border border-[#e8e8e4] overflow-hidden">
      ...
      <div className="flex items-center gap-2.5 px-4 py-3 border-b border-[#e8e8e4] bg-[#fafaf8]">
        <div className="w-7 h-7 rounded-full bg-[#D1FAE5] flex items-center justify-center text-[12px] font-bold text-[#065c41] flex-shrink-0">
      ...
      <div className="p-4">
        {preview.status === "loading" && (
          <div className="space-y-2 animate-pulse">
            ...
            <p className="text-[10px] text-[#6EE7B7] flex items-center gap-1 pt-1">
        ...
        {preview.status === "error" && (
          <p className="text-[12px] text-[#B85C33]">{preview.error}</p>
        )}
