    ...
    return (
        <section className="py-24 bg-slate-950 overflow-hidden relative">
            ...
            <div className="container mx-auto px-6 max-w-6xl relative z-10">
                ...
                >
                    <h2 className="text-4xl md:text-5xl font-extrabold tracking-tight text-white mb-6 font-sans">
                ...
                <div className="space-y-32">
                    ...
                    <div className="flex flex-col lg:flex-row items-center gap-16 lg:gap-24">
                        ...
                        >
                            <div className="relative w-full h-[32rem] md:h-[40rem] mx-auto overflow-hidden flex items-end justify-center">
                                <Image
                        ...
                        >
                            ...
                            <blockquote className="border-l-4 border-emerald-500/50 pl-6 py-2 text-xl text-slate-300 italic font-medium leading-relaxed bg-gradient-to-r from-emerald-500/5 to-transparent">
                    ...
                    <div className="flex flex-col lg:flex-row-reverse items-center gap-16 lg:gap-24">
                        ...
                        >
                            ...
                            <blockquote className="border-l-4 border-blue-500/50 pl-6 py-2 text-xl text-slate-300 italic font-medium leading-relaxed bg-gradient-to-r from-blue-500/5 to-transparent">
