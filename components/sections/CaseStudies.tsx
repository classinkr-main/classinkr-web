                    ...
                    <Card className="border border-[rgba(0,0,0,0.08)] bg-white transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5">
                        <CardContent className="p-8">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <div className="font-bold text-[#111110]">대치 시그니처 수학</div>
                            ...
                            <div className="mb-6 space-y-2">
                                ...
                                <p className="text-[#615D59] text-sm break-keep">지점별로 천차만별인 강사 역량과 주먹구구식 평가 시스템.</p>
                            </div>
                            <div className="mb-6 space-y-2">
                                <div className="text-sm font-semibold text-[#084734] uppercase">결과 (Result)</div>
                                <p className="text-[#111110] font-medium break-keep">도입 2주 만에 전 지점 평가 방식 100% 통합 및 행정 리소스 60% 절감.</p>
                            </div>
                            <blockquote className="bg-[#F6F5F4] p-4 rounded-lg italic text-[#615D59] text-sm relative break-keep">
                                ...
                                <div className="mt-3 text-right font-bold text-[#A39E98] not-italic text-xs break-keep">- 김민준 대표원장</div>
                            </blockquote>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border border-[rgba(0,0,0,0.08)] bg-white transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5">
                        <CardContent className="p-8">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <div className="font-bold text-[#111110]">하이엔드 영재어학원</div>
                                    <div className="text-xs text-muted-foreground">초·중등 프리미엄 관, 원생 800명+</div>
                                </div>
                            </div>
                            <div className="mb-6 space-y-2">
                                <div className="text-sm font-semibold text-[#A39E98] uppercase">도전 과제 (Challenge)</div>
                                <p className="text-[#615D59] text-sm break-keep">대형식 강의 위주 수업으로 인한 개별 학생 수업 몰입도 하락.</p>
                            </div>
                            <div className="mb-6 space-y-2">
                                <div className="text-sm font-semibold text-[#084734] uppercase">결과 (Result)</div>
                                <p className="text-[#111110] font-medium break-keep">과제 완수율 65%에서 92%로 급상승, 퇴원율 3배 감소.</p>
                            </div>
                            <blockquote className="bg-[#F6F5F4] p-4 rounded-lg italic text-[#615D59] text-sm relative break-keep">
                                <Quote className="w-4 h-4 text-[#A39E98]/60 absolute -top-2 -left-2 fill-current" />
                                &quot;인터랙티브 화이트보드와 AI 자동 채점 덕분에 수십 명이 듣는 대형 강의실에서도 학생 한 명 한 명을 1:1 과외처럼 밀착 관리할 수 있게 되었습니다.&quot;
                                <div className="mt-3 text-right font-bold text-[#A39E98] not-italic text-xs break-keep">- 이서윤 원장</div>
                            </blockquote>
                        </CardContent>
                    </Card>
                    ...
                    <Card className="border border-[rgba(0,0,0,0.08)] bg-white md:col-span-2 lg:col-span-1 transition-all duration-200 hover:shadow-lg hover:-translate-y-0.5">
                        <CardContent className="p-8">
                            <div className="flex items-center gap-4 mb-6">
                                ...
                                <div>
                                    <div className="font-bold text-[#111110]">이데아 수능 전문학원</div>
                                    <div className="text-xs text-muted-foreground">전국 프랜차이즈, 15개 가맹점</div>
                                </div>
                            </div>
                            <div className="mb-6 space-y-2">
                                <div className="text-sm font-semibold text-[#A39E98] uppercase">도전 과제 (Challenge)</div>
                                <p className="text-[#615D59] text-sm break-keep">에이스 강사에 대한 의존도가 높아 강사 퇴사 시 원생 대규모 이탈 리스크 상존.</p>
                            </div>
                            <div className="mb-6 space-y-2">
                                <div className="text-sm font-semibold text-[#084734] uppercase">결과 (Result)</div>
                                <p className="text-[#111110] font-medium break-keep">학원 고유 시스템 구축 성공, 신입 강사 적응 기간 3개월 → 2주로 단축.</p>
                            </div>
                            <blockquote className="bg-[#F6F5F4] p-4 rounded-lg italic text-[#615D59] text-sm relative break-keep">
                                <Quote className="w-4 h-4 text-[#A39E98]/60 absolute -top-2 -left-2 fill-current" />
                                &quot;이제 특정 강사의 개인기에 의존하지 않습니다. 철저한 데이터 공개로 신뢰를 얻었고, 본사는 확실한 운영 및 교육 퀄리티 통제력을 회복했습니다.&quot;
                                <div className="mt-3 text-right font-bold text-[#A39E98] not-italic text-xs break-keep">- 박정호 대표</div>
                            </blockquote>
                        </CardContent>
                    </Card>
                </div>
