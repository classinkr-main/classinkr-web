export const CLASSIN_POSITIONING = {
  ...
  heroHeadline: "전자칠판을 넘어, 수업 시스템 OS로",
  heroBody:
    "좋은 장비를 들여도 수업 준비·판서·녹화·과제·데이터가 따로 놀면, 운영은 다시 사람에게 의존합니다. Classin은 하드웨어와 소프트웨어를 한 흐름으로 묶어 강사 리소스를 줄이고, 누가 가르쳐도 같은 수업 품질이 나오게 합니다.",
  localReality:
