export const CLASSIN_POSITIONING = {
  ...
  edbSummary:
    "EDB는 Classin 칠판 파일입니다. 판서, 이미지, 텍스트를 상호작용 가능한 상태로 저장하고 다시 불러올 수 있어 최대 50페이지 칠판과 함께 수업 교안, 활동 자료, 우수 강사 템플릿을 재사용하는 데 적합합니다.",
  adminDataSummary:
  ...
  chatbot: {
    welcome:
      "안녕하세요! Classin 상담 가이드예요. 도입, 수업 운영, 전자칠판, 계정/결제 무엇이든 편하게 물어보시면 바로 정리해드릴게요.",
    identitySummary:
    ...
    starterQuestions: [
      ...
      "우리 학원에 맞는 90일 도입 순서를 잡고 싶어요",
      "전자칠판, 녹화, EDB, LMS를 어떻게 한 흐름으로 쓰나요?",
    ],
    fallbackQuestions: [
