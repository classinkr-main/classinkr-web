...
const DEFAULT_OBJECTS: XiaoshouyiObjectConfig[] = [
  ...
  },
  {
    ...
    amountFields: ["CurrencyAmount__c", "currencyShow__c", "currency__c"],
    occurredAtFields: ["expireTime__c", "DateBack__c", "ContractEndDate__c", "LastClassDate__c", "updatedAt", "createdAt"],
  },
  {
