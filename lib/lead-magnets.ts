...
// 순수 라벨/카운트 헬퍼(getLeadMagnetItemCount·상태·게이트·티어·카테고리 라벨)는
// lib/lead-magnets-helpers.ts로 이전했다. 이 모듈은 leadMagnets 배열 top-level 평가로
// data/lead-magnets.json(213KB) 전체를 끌고 오므로, 데이터를 참조하지 않는 헬퍼만 쓰는
// 임포터는 반드시 helpers 모듈에서 가져와야 한다 — 여기서 재-export 금지.
