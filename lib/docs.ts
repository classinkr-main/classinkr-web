...
const docs: DocArticle[] = [
  ...
  },
  {
    ...
    description: "한국에 공급되는 ClassIn Board A 시리즈(S65·S75·S86·S110) 네 모델의 권장 사용 공간, 화면 크기, 규격서 기준 주요 사양, 선택 기준을 정리했습니다.",
    audience: "도입 검토자, 학원 관리자, 설치 상담 담당자",
    updatedAt: "2026-05-30",
    readMinutes: 7,
    featured: true,
    tags: ["모델 선택", "스펙", "S65", "S75", "S86", "S110"],
    keywords: ["Classin Board S65", "Classin Board S75", "Classin Board S86", "Classin Board S110", "BS65A", "BS75A", "BS86A", "BS110A", "전자칠판 스펙", "전자칠판 크기", "화면 크기", "OPS", "스탠드", "벽걸이"],
    chatbotSummary: "한국에 공급되는 ClassIn Board는 A 시리즈 네 모델(S65·S75·S86·S110)로 구성됩니다. 모델명은 각각 BS65A·BS75A·BS86A·BS110A이고, 화면은 65·75·86·110인치입니다. S65는 소규모 공부방·교습소, S75는 10명 안팎 교실, S86은 10명 이상 일반 강의실, S110은 대형 강의실·강당에 적합합니다. 네 모델 모두 4K(3840×2160) 해상도, 50점 적외선 터치, 8GB·256GB SSD를 갖춘 12세대 i5(i5-12400) OPS 컴퓨터를 기본 제공합니다. S65·S75·S86은 60Hz·3mm 강화유리, S110은 120Hz·4mm 강화유리입니다. 벽걸이 거치대와 이동형 스탠드는 전 모델 선택(옵션) 구성입니다. 사양은 규격서 V1.0 기준이며 견적·제안 전 최신 규격서로 한 번 더 확인하세요.",
    sections: [
      {
        heading: "한국은 A 시리즈 네 모델입니다",
        body: "한국에 공급되는 ClassIn Board는 A 시리즈(2세대) 네 모델뿐입니다. 화면 크기만 보고 고르기보다 학생 수, 맨 뒷자리 시야 거리, 교실 폭, 설치 벽면, 이동 여부를 함께 봐야 합니다.",
        steps: [
          "S65(BS65A, 65인치): 소규모 공부방, 교습소, 1:1·소그룹 수업에 적합합니다.",
          "S75(BS75A, 75인치): 10명 안팎 교실이나 세미나실에 적합합니다.",
          "S86(BS86A, 86인치): 10명 이상 일반 강의실에서 가장 범용적으로 검토할 수 있습니다.",
          "S110(BS110A, 110인치): 대형 강의실·강당 등 가장 큰 공간에 적합하며, 120Hz 화면으로 움직임이 부드러운 최상위 모델입니다.",
        ],
      },
      {
        heading: "모델별 크기와 화면 사양",
        body: "규격서(V1.0) 기준 모델명·치수·화면 사양입니다. 모든 모델이 4K(3840×2160) 해상도, 16:9 화면, 178° 시야각, 밝기 350cd/m² 이상, 수명 5만 시간 이상입니다. 견적서·제안서에 넣기 전에는 최신 규격서로 한 번 더 검수하세요.",
        steps: [
          "S65 — 모델명 BS65A, 65인치. 본체 1,508.71 × 889.87 × 94.79mm, 순중량 41.5kg. 60Hz, 명암비 5000:1, 3mm 강화유리.",
          "S75 — 모델명 BS75A, 75인치. 본체 1,730.63 × 1,015.22 × 95.5mm, 순중량 54.5kg. 60Hz, 명암비 5500:1, 3mm 강화유리.",
          "S86 — 모델명 BS86A, 86인치. 본체 1,976.63 × 1,153.31 × 95.5mm, 순중량 67.0kg. 60Hz, 명암비 4000:1, 3mm 강화유리, 양측 터치바 설계.",
          "S110 — 모델명 BS110A, 110인치. 본체 2,520.55 × 1,457.20 × 110.0mm, 순중량 137kg. 120Hz, 명암비 1200:1, 4mm 강화유리, 양측 터치바 설계.",
      ...
      },
      {
        ...
        steps: [
          "터치 포인트는 S65·S75·S86·S110 모두 50점입니다.",
          "터치 방식은 적외선(IR) 방식이며, 손가락이나 전용 펜처럼 빛이 통하지 않는 물체를 인식합니다.",
          "터치 응답 속도 2ms, 필기 높이 1mm, 터치 정밀도 ±1mm, 최소 인식 물체 1.5mm입니다.",
          "강화유리는 S65·S75·S86이 3mm, S110이 4mm이며, 모두 AG 방현·AF 지문방지 처리되어 있습니다.",
          "양측 터치바(측면 제스처바)는 S86과 S110에 적용되어 있고, S65·S75에는 없습니다.",
        ],
      },
      {
        ...
        steps: [
          "OPS 컴퓨터는 네 모델 모두 기본 제공이며, 구성은 12세대 i5(i5-12400)·8GB 메모리·256GB SSD로 동일합니다. (탈착식 80핀 Intel Core 모듈)",
          "내장 안드로이드는 Android 11, 메모리 4GB·저장 32GB로 네 모델 공통입니다.",
          "스피커는 전 모델 2.0채널, 2×15W입니다.",
          "내장 마이크는 S65·S75·S86이 8배열(수음 거리 10m)이고, S110 규격서에는 내장 마이크가 별도 기재되어 있지 않아 도입 시 별도 확인이 필요합니다.",
          "벽걸이 거치대와 이동형 스탠드, 교편(포인터)은 네 모델 모두 선택(옵션) 구성이며, 기본 동봉품은 전원선·페이지 펜·적외선 펜입니다.",
        ],
      },
      {
        heading: "선택 전 현장 체크",
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          "전원은 100~240V를 사용하며 대기 전력은 0.5W 미만입니다. 최대 소비전력은 모델별로 달라(S65 265W·S75 315W·S86 460W·S110 850W) 멀티탭 정격 용량을 넉넉히 잡습니다.",
