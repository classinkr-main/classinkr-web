...
const docs: DocArticle[] = [
  ...
  },
  {
    ...
    keywords: ["ClassIn Board S 시리즈", "Classin Board 안전", "전자칠판 안전 사용", "전자칠판 청소", "전자칠판 전원", "전자칠판 터치 잠금", "전자칠판 입력 소스", "무선 투영", "주석", "작은 제어 화면", "보조 조작 패널", "妙控屏", "Type-C", "HDMI Touch", "LAN", "OPS"],
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          "한 명 또는 여러 명의 기립을 구분해 단인·다인 클로즈업를 제공합니다.",
      ...
      },
      {
        ...
        steps: [
          ...
          "수업 화면은 녹화·원격 송출에서 전경과 클로즈업가 자동으로 전환됩니다.",
