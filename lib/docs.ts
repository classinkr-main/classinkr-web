...
const docs: DocArticle[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "AI 기능 — 강사 리소스를 줄이는 것", body: "AI는 별도 화면이 아니라 활동을 만들고 채점하는 흐름 안에 들어 있습니다. 활용 시나리오는 AI 튜터와 AI 평가 활용하기에서 다룹니다.", steps: ["AI 자동 채점: 숙제 작성 화면의 AI 채점 토글로 채점을 보조합니다.","AI 출제: 시험·숙제를 AI로 초안 생성합니다.","AI 언어활동: 따라읽기·받아쓰기·외워말하기로 영어·중국어 말하기/듣기 연습을 자동화합니다.","수업 후 분석: 수업 활동은 AI 분석·요약을 지원합니다.","참고: 문제 은행 제공 범위는 기관 설정·계약에 따라 달라질 수 있습니다."] },
