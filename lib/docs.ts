...
const docs: DocArticle[] = [
  ...
  },
  {
    ...
    relatedSlugs: ["board-basic-operation", "board-lineup-specs", "board-writing-touch", "board-ai-camera-mic"],
  },
  {
    ...
    keywords: ["전자칠판 사용법", "스마트 보드 사용법", "전자칠판 버튼 위치", "손가락 제스처", "한 손가락 필기", "두 손가락 스크롤", "네 손가락 펜툴", "무선 미러링", "화면 미러링", "HDMI 전환", "입력 소스 전환", "전원 버튼", "OPS 전환"],
    ...
    relatedSlugs: ["board-writing-touch", "board-overview", "board-ai-camera-mic"],
  },
  {
  ...
  },
  {
    ...
    relatedSlugs: ["board-overview", "classroom-tools", "classin-607-update"],
  },
  {
  ...
  },
  {
    ...
    relatedSlugs: ["board-lineup-specs", "board-ai-camera-mic", "webcam-cms-setup-t1-panorama"],
  },
  {
    slug: "mic-dt2-pro",
    category: "hardware",
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          "방안 1은 천장형 스피커를 쓰며, 단계별(逐級) 확음으로 발언자가 이동해도 교실 어느 위치에서나 일관된 음장을 유지합니다.",
  ...
  },
  {
    ...
    keywords: ["ClassIn Cam T1", "ClassIn Cam S1", "CS11A", "CS21A", "교사 추적 카메라", "학생 정위 카메라", "AI 카메라", "전경 특写", "4K 카메라", "하이브리드 수업 카메라", "POE 카메라"],
    chatbotSummary: "ClassIn Cam T1(CS11A)은 교사를 자동 추적하는 카메라, S1(CS21A)은 학생의 기립·착석을 인식해 정위하는 카메라입니다. 두 모델 모두 1/2.8인치 842만 화소 4K 센서로 단일 렌즈에서 전경(파노라마)과 특写 두 화면을 동시에 출력하고, 딥러닝 추적·정위와 자동 화면 전환을 지원합니다. 최대 4K 30fps, POE·DC12V·USB 중 선택 전원, 소비전력 5W 미만이며, T1은 교사 추적·판서 특写, S1은 발표 학생 자동 정위에 적합합니다. 추적 범위와 차폐 영역은 설치 단계에서 설정합니다.",
    sections: [
      {
        heading: "T1과 S1의 역할",
        ...
        steps: [
          ...
          "두 카메라 모두 단일 렌즈로 전경(파노라마)과 특写(클로즈업) 화면을 동시에 출력합니다.",
      ...
      },
      {
        ...
        steps: [
          ...
          "단일 렌즈에서 전경과 추적 특写 두 화면을 동시에 촬영합니다.",
          "내장 스마트 디렉팅으로 전경과 특写 화면이 자동 전환됩니다.",
      ...
      },
      {
        ...
        steps: [
          "교사 신장에 맞춰 특写 크기를 자동으로 맞추는 신장 자적응 기능을 제공합니다.",
          "목표가 오래 정지해 있어도 잠금을 유지하고, 조명 변화·다른 움직임·프로젝터 화면에 흔들리지 않습니다.",
          "여러 추적 모드와 판서(板书) 특写 기능을 제공합니다.",
      ...
      },
      {
        ...
        steps: [
          ...
          "학생의 원근에 따라 자동 변배해 항상 적절한 크기를 유지합니다.",
          "한 명 또는 여러 명의 기립을 구분해 단인·다인 특写를 제공합니다.",
      ...
      },
      {
        ...
        steps: [
          ...
          "수업 화면은 녹화·원격 송출에서 전경과 특写가 자동으로 전환됩니다.",
