...
const docs: DocArticle[] = [
  ...
  },
  {
    ...
    chatbotSummary: "클래스인 가격은 학원 규모·상황·패키지에 따라 달라서 한 번에 금액을 단정하지 않습니다. 먼저 규모와 상황을 확인한 뒤 패키지 기준으로 안내드리며(패키지 구성은 Education OS 안내 페이지에서 확인), 정확한 금액과 계약 조건은 상담에서 확정합니다. 견적은 전자칠판 단품이 아니라 전자칠판 + OPS 내장 PC + 카메라 + 스탠드/벽걸이 + 소프트웨어 + 온보딩이 묶인 수업 시스템 OS 구성으로 봅니다.",
    sections: [
