...
const docs: DocArticle[] = [
  ...csFigmaDocs,
  {
    ...
    readMinutes: 7,
    featured: true,
    tags: ["수업 시스템 OS", "도입 상담", "전자칠판", "EDB", "녹화", "LMS", "관리자 데이터"],
    keywords: [
      "수업 시스템 OS",
      "Classin 차이",
      "Zoom과 차이",
    ...
    sections: [
      {
        ...
        media: [
          {
            type: "image",
            src: "/images/docs/diagrams/lesson-os-map.svg",
            alt: "수업 OS 개념 맵: 수업 전 준비, 수업 중 진행(판서·녹화·수업 도구), 수업 후 운영(다시보기·LMS·데이터)이 하나의 흐름으로 연결되는 구조",
            caption: "수업 전·중·후가 하나의 수업 OS 흐름으로 연결됩니다.",
            width: 1440,
            height: 760,
          },
        ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          "경로: 칠판 > [수업 도구] > [개인 칠판] > 그림판 > [배포]",
          "개인 칠판은 학생별 풀이 과정을 동시에 확인하거나 첨삭할 때 사용하며, 문제 배포는 위 경로 순서로 진행합니다.",
    ...
    sections: [
      {
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/classin-ai-비활성화-안내.png",
            alt: "관리자 대시보드 일반 설정 → 부가가치 서비스 탭에서 AI 에이전트 옵션 토글을 확인하는 화면",
            caption: "기관 계정의 AI 기능 활성화 여부는 대시보드 일반 설정 → [부가가치 서비스]의 AI 에이전트 토글에서 확인·변경합니다",
            width: 1440,
            height: 2000,
          },
        ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "웹 라이브와 플레이백",
        body: "웹 라이브는 수업을 실시간으로 확인하거나 외부 시청 경로를 제공할 때, 플레이백은 수업 후 복습과 운영 검수에 사용합니다. 시청자는 별도 앱 설치 없이 웹 링크로 참여할 수 있습니다.",
        steps: [
          "경로: 대시보드 > [라이브&플레이백] > [웹 페이지 링크]",
          "웹 참여 링크를 복사해 재원생 또는 외부 참여자에게 공유합니다.",
          "라이브 공개 범위와 접근 권한을 먼저 확인합니다.",
          "수업 중 문제가 발생하면 교실 상태, 네트워크, 카메라·마이크 상태를 함께 확인합니다.",
          "수업 종료 후 녹화 영상과 판서 자료가 정상 저장됐는지 확인합니다.",
          "경로: [라이브&플레이백] > [오퍼레이션] > [관리]",
          "수업 종료 후에는 위 경로에서 시청자 수, 좋아요 수 등 통계를 확인할 수 있습니다.",
      ...
      {
        heading: "자주 묻는 상황",
        body: "관리자 데이터 화면을 운영하다 보면 반복적으로 나오는 상황들입니다. 대응 기준을 미리 정해 두면 현장 판단이 빨라집니다.",
        steps: [
          "모니터링이 감시로 느껴진다는 우려가 있을 때: 수업 모니터링은 관리자가 권한 범위 안에서 보는 운영 데이터 가시성입니다. 관리자가 수업에 들어가도 별도 알림이 가지 않으므로, 운영 목적과 범위를 교사·학생에게 미리 안내합니다.",
          "학생이 '소리가 안 들려요', '입장이 안 돼요'라고 할 때: 해당 학생의 접속 상태와 기기·환경 정보를 확인해 원인을 좁힌 뒤(미입장·연결 끊김·기기 권한 등) 재입장, 마이크·카메라 권한 확인, 네트워크 점검을 안내합니다.",
          "기간별 운영 기록을 자료로 남기고 싶을 때: 수업 횟수, 스토리지 소비 현황 등 통계 데이터를 Excel로 다운로드하면 수업일자, 수업 지속 시간, 담당 교사, 출석 학생 인원을 행 단위로 확인할 수 있습니다.",
          "충전제를 사용하는 학원이라면: 조건 검색으로 기간 내 포인트 차감 내역을 확인해 사용량 흐름을 읽고 충전 시점을 미리 계획합니다.",
          "다운로드한 통계 파일에는 학생 정보가 포함되므로, 권한 있는 담당자만 보관·공유하고 외부 전달 시 마스킹과 접근 관리를 적용합니다.",
        ],
      },
      {
        heading: "데이터 해석 시 확인 포인트",
        body: "지표는 보는 것보다 해석 기준을 통일하는 것이 중요합니다. 아래 기준을 지키면 잘못된 운영 판단을 줄일 수 있습니다.",
        steps: [
          "기간 조건을 빼고 비교하지 않습니다. 주·월 단위처럼 같은 길이의 기간으로 맞춰야 추세가 의미를 가집니다.",
          "한 주의 단발 수치보다 3주 이상 이어지는 방향성을 신뢰하고, 시험·방학 등 이벤트가 낀 기간은 따로 표시해 둡니다.",
          "출석 학생 인원을 학습 성취로 단정하지 않습니다. 참여 신호일 뿐이므로 학습 결과는 LMS의 과제·성적과 함께 봅니다.",
          "포인트 차감 내역을 정산 자료로 바로 쓰지 않습니다. 정확한 금액은 회계 시스템과 교차 확인하거나 상담으로 점검합니다.",
          "오프라인 출석이나 정교한 학습 리포트가 필요하면 현재 기능으로 단정하지 말고 별도 시스템 연동 여부를 상담으로 확인합니다.",
        ],
      },
    ],
  ...
  {
    slug: "hardware-spec-installation-faq",
    category: "hardware",
    docType: "faq",
    productArea: "hardware",
    title: "ClassIn Board S시리즈 사양 & 설치 환경 FAQ",
    description: "S65, S75, S86, S110 모델별 사양 비교, OPS 모듈 스펙, 현장 벽체 보강 및 설치 조건, A/S 안내를 정리했습니다.",
    audience: "학원/학교 관리자, 설치 담당자, IT 구매 담당자",
    updatedAt: "2026-07-27",
    readMinutes: 5,
    featured: true,
    tags: ["전자칠판", "S시리즈", "설치조건", "OPS사양", "AS보증"],
    keywords: [
      "전자칠판 사양",
      "전자칠판 S시리즈 설치 조건",
      "S시리즈 설치 조건",
    ...
    chatbotSummary: "ClassIn Board S시리즈는 S65(65인치), S75(75인치), S86(86인치), S110(110인치 4K UHD) 라인업으로 구성됩니다. Intel Core i5/i7 OPS 컴퓨터 모듈을 탑재하여 윈도우 환경에서 단독 구동되며, 40포인트 터치 입력과 zero-gap 결합 기술을 지원합니다. 벽걸이 설치 시 전용 브래킷과 벽체 보강(석고보드 합판 보강)이 필요하며, 1.5m 이내 정격 전원선 및 Type-C 케이블 사용을 권장합니다. 무상 A/S 보증 기간은 기본 1년~2년(출장 점검 지원)입니다.",
    sections: [
      {
        heading: "S시리즈 모델별 규격 및 주요 사양",
        body: "수업 공간 크기에 맞춰 S65(소형 교실), S75(중형 교실), S86(대강의실), S110(대강당)을 선택할 수 있습니다. 전 모델 4K UHD 고해상도와 반사 방지 강화유리가 적용되어 있습니다.",
        steps: [
          "S65 / S75: 20~30인 규모 교실에 적합하며, 40포인트 터치를 지원합니다.",
          "S86 / S110: 50인 이상 대형 강의실에 적합하며, 광시야각 IPS 패널과 듀얼 AI 카메라가 기본 탑재됩니다.",
          "OPS 컴퓨터: Intel Core i5/i7, 16GB RAM, 256GB/512GB SSD 탑재로 Windows 11 환경을 단독 구동합니다.",
        ],
      },
      {
        heading: "현장 설치 환경 체크리스트 (벽체/스탠드/전원)",
        body: "설치 전 벽체 재질, 전원 용량, 이동 동선을 확인해야 안전하고 단단하게 고정할 수 있습니다.",
        steps: [
          "벽걸이 설치: 콘크리트 벽면은 직결 앵커 고정, 석고보드 벽면은 최소 15mm 이상 합판 보강 작업이 필요합니다.",
          "이동형 스탠드: 바닥 수평 상태와 이동 동선 문폭(최소 90cm 이상)을 사전 점검합니다.",
          "전원 규격: 220V 정격 콘센트를 사용하며, 접지 단자가 포함된 3구 케이블을 연결합니다.",
        ],
      },
      {
        heading: "설치 후 사용 환경과 관리 포인트",
        body: "설치가 끝난 뒤에도 사용 환경과 일상 관리에 따라 화면·터치·OPS 안정성이 달라집니다. 운영팀과 아래 기준을 공유해 두면 좋습니다.",
        steps: [
          "작동 환경은 온도 0~40℃, 습도 80%RH 이하를 기준으로 하며, 발열과 환기를 위해 보드 뒷면과 통풍구 주변에 여유 공간을 둡니다.",
      ...
      {
        heading: "A/S 보증 및 점검 절차",
        body: "정품 ClassIn Board는 출장 점검 서비스를 지원하며, 고객센터를 통해 즉시 접수할 수 있습니다.",
        steps: [
          "무상 보증 기간: 구입일 기준 기본 1년(프로모션 적용 시 최대 2년) 무상 출장 점검을 제공합니다.",
          "이상 증상 발생 시: 전원 재부팅 및 케이블 점검 후, 고객센터 또는 채널톡으로 접수합니다.",
        ],
      },
      {
        heading: "함께 보면 좋은 흐름",
        body: "이 FAQ는 도입 검토 단계의 요약입니다. 견적·설치·운영 단계로 넘어가면 아래 문서를 이어서 확인하세요.",
        steps: [
          "모델별 치수·터치·OPS 상세 사양은 '모델별 스펙과 선택 가이드'에서 규격서 기준으로 확인합니다.",
          "설치 전 공간, 전원, 네트워크, 반입 동선 점검은 '설치 전 준비 체크리스트'를 따라 진행합니다.",
          "전원·접지, 이동, 화면 보호 등 안전 수칙은 'ClassIn Board S 시리즈 안전 사용 기본 지침'에서 확인합니다.",
          "설치 후 처음 켤 때의 버튼 위치와 기본 조작은 '전자칠판 기본 사용 설명서'에서 확인합니다.",
        ],
      },
    ],
    relatedSlugs: ["board-overview"],
  },
  {
    slug: "software-pricing-quote-bundle-faq",
    category: "software",
    docType: "faq",
    productArea: "software",
    title: "ClassIn 소프트웨어 요금제 & 전자칠판 결합 견적 FAQ",
    description: "Pro/Enterprise 요금제 기능 비교, 동시 접속 계정 기준, 하드웨어 번들 구매 할인 및 견적서 발급 절차입니다.",
    audience: "학원 원장, 교장, IT 구매 담당자, 운영 관리자",
    updatedAt: "2026-07-27",
    readMinutes: 5,
    featured: true,
    tags: ["요금제", "Pro요금제", "Enterprise", "번들할인", "견적서"],
    keywords: [
      "소프트웨어 가격",
      "소프트웨어 Pro 요금제",
      "소프트웨어 Pro 요금제랑 Enterprise 차이",
      "Pro 요금제",
      "Enterprise 요금제",
      "전자칠판 결합 할인",
      "결합 할인",
    ...
    chatbotSummary: "ClassIn 소프트웨어는 중소형 학원용 Pro 요금제와 대형 기관/대학교용 Enterprise 요금제로 제공됩니다. Pro 요금제는 계정당 월 구독 형태로 LMS, 자동 녹화, 100인 동시 수업을 제공하며, Enterprise 요금제는 커스텀 브랜딩, 출결/결제 API 연동, 전담 CS 매니저를 포함합니다. ClassIn Board(전자칠판) 구매 시 소프트웨어 1년 라이선스 최대 30% 번들 할인 혜택이 적용되며, 문의 페이지(/contact)에서 즉시 맞춤 견적서를 받아보실 수 있습니다.",
    sections: [
      {
        heading: "Pro vs Enterprise 요금제 비교",
        body: "학원/기관의 규모와 운영 방식에 따라 최적의 라이선스 모델을 선택할 수 있습니다.",
        steps: [
          "Pro 요금제: 50~200명 규모 학원에 권장하며, 무제한 라이브 수업, LMS 데이터 저장, 판서 템플릿을 포함합니다.",
          "Enterprise 요금제: 500명 이상 대형 학원/체인형 기관에 권장하며, 학원 자체 로고/앱 커스텀, ERP API 연동을 지원합니다.",
        ],
      },
      {
        heading: "ClassIn Board (하드웨어) + Software 결합 번들 할인",
        body: "전자칠판과 소프트웨어를 함께 도입하는 교육 기관을 위해 패키지 할인을 제공합니다.",
        steps: [
          "전자칠판 1대 도입 시: ClassIn Pro 1년 라이선스 20% 할인 패키지 제공.",
          "전자칠판 3대 이상 도입 시: Enterprise 맞춤 컨설팅 및 소프트웨어 30% 번들 할인 지원.",
        ],
      },
      {
        heading: "견적서 발급 및 무상 데모(Demo) 신청",
        body: "도입 전 무상 체험 및 견적서를 받아보실 수 있습니다.",
        steps: [
          "무상 데모 신청: 홈페이지 상단 '데모 신청' 버튼을 통해 14일 무료 체험 계정을 즉시 발급받습니다.",
          "견적서 발급: 문의 페이지(/contact)에 학원명, 교실 수, 연락처를 입력하시면 2시간 이내 이메일/카카오톡으로 맞춤 견적서가 전달됩니다.",
        ],
      },
      {
        heading: "견적·상담 전에 준비하면 좋은 정보",
        body: "견적서와 상담 답변을 빠르고 정확하게 받으려면 학원 운영 정보를 먼저 정리해 두는 것이 좋습니다.",
        steps: [
          "강사 수, 동시 수업 수, 예상 학생 수를 적어 둡니다. 운영 규모가 정리되어 있으면 요금제 검토와 상담이 빨라집니다.",
          "학원명, 교실 수, 연락처를 준비합니다. 견적서 발급 시 문의 페이지에 입력하는 기본 정보입니다.",
          "메인 관리자 계정을 누구 명의로 할지 미리 정합니다. 결제에 로그인한 계정이 그대로 학원(기관)의 메인 관리자 계정이 되므로, 개인 계정보다 학원 공용 운영 계정을 권장합니다.",
          "화면이나 안내 자료에 보이는 금액을 확정 금액으로 단정하지 않습니다. 표시되는 가격과 결제 가능 항목은 체크아웃 및 상담 단계에서 최종 확인됩니다.",
          "전자칠판을 함께 도입한다면 설치 환경(벽체 재질, 전원 용량, 이동 동선)도 상담 때 함께 확인합니다.",
        ],
      },
      {
        heading: "함께 보면 좋은 흐름",
        body: "요금제 확인 이후의 결제·전환 과정은 아래 흐름으로 이어집니다.",
        steps: [
          "소프트웨어 플랜과 온라인 결제는 체크아웃(/checkout)에서 확인합니다. 하드웨어와 대형 기관 도입은 전담 매니저가 견적과 구축 범위를 안내합니다.",
          "유료 전환 절차와 전환 전 체크리스트는 '유료 계정 전환' 문서에서 확인합니다.",
          "결제 후에는 곧바로 계정 인증을 진행해 수업 녹화·웹 라이브 같은 제한 기능을 풀어 둡니다.",
          "급한 도입 상담은 문의 페이지의 카카오톡 채널로 바로 연결할 수 있습니다.",
          "전자칠판 모델별 사양과 설치 조건은 'ClassIn Board S시리즈 사양 & 설치 환경 FAQ'에서 확인합니다.",
        ],
      },
    ],
    relatedSlugs: ["software-overview"],
  },
  {
    slug: "board-overview",
    category: "hardware",
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "터치 잠금·눈 보호 같은 보조 기능",
        body: "기본 조작에 더해, 수업 운영에서 자주 쓰는 보조 기능이 대형 화면 제어 메뉴에 모여 있습니다. 화면 청소나 조도 조정처럼 수업 중 자주 생기는 상황에 유용합니다.",
        steps: [
          "대형 화면 제어 메뉴에서 투영, 주석, 터치 잠금, 눈 보호, 입력 소스, 설정, 볼륨, 밝기, 화면 끄기, 재시작, 종료를 조작할 수 있습니다.",
          "수업 중 학생이 화면을 만지거나 화면을 청소해야 하면 터치 잠금을 먼저 켭니다.",
          "교실 조도와 학생 좌석 거리에 맞춰 눈 보호 모드, 밝기, 볼륨을 조정합니다.",
          "화면 어디서나 5손가락 제스처로 작은 제어 화면(보조 조작 패널)을 열 수 있습니다. 멀리 있는 버튼을 누르기 힘들 때 사용합니다.",
          "세부 안내는 'ClassIn Board S 시리즈 안전 사용 기본 지침' 문서에서 확인합니다.",
        ],
      },
      {
      ...
      {
        heading: "자주 묻는 상황",
        body: "처음 사용할 때 자주 문의되는 증상과 확인 순서입니다. 대부분 케이블 연결과 화면 테두리 상태에서 원인을 찾을 수 있습니다.",
        steps: [
          "입력 소스가 회색으로 보이거나 선택되지 않으면 해당 포트에 신호가 없는 상태입니다. 케이블, 외부 기기 전원, 입력 포트를 확인합니다.",
          "HDMI로 연결한 외부 기기에서 터치 입력까지 쓰려면 HDMI 신호 연결과 HDMI Touch 입력 연결을 함께 확인합니다.",
          "터치가 튀면 적외선 터치 방식 특성상 화면 테두리(베젤)에 먼지나 이물질이 끼지 않았는지 확인하고 주기적으로 닦아 줍니다.",
  ...
  },
  {
    ...
    chatbotSummary: "한국 공급 기준 ClassIn Board는 S75·S86·S98 Pro·S110 사양을 우선 확인합니다. 모델명은 각각 BS75A·BS86C·BSCP98A·BS110A이고 화면은 75·86·98·110인치입니다. 네 모델 모두 4K(3840×2160) 해상도, 16:9 화면, 178° 시야각, 밝기 350cd/m² 이상, 수명 5만 시간 이상, 50점 적외선 터치, Android 11 내장 시스템, 탈착식 Intel Core i5/i7 OPS, Wi-Fi ax·BT5.0, 2×15W 스피커를 기본으로 갖춥니다. 벽걸이 설치 시 전용 브래킷과 벽체 보강(석고보드 15mm 이상 합판 보강)이 필요하며, 무상 A/S 보증기간은 기본 1년~2년(출장 점검 지원)입니다.",
    sections: [
      {
      ...
      {
        heading: "현장 설치 환경 체크리스트 & 무상 A/S 보증 조건",
        body: "안전하고 단단한 고정을 위해 벽체 재질, 전원 용량, 이동 동선을 확인해야 하며, 무상 출장 점검 서비스를 지원합니다.",
        steps: [
          "벽걸이 설치 조건: 콘크리트 벽면은 직결 앵커 고정, 석고보드 벽면은 최소 15mm 이상 합판 보강이 필요합니다.",
          "이동형 스탠드: 바닥 수평 상태와 이동 동선 문폭(최소 90cm 이상)을 사전 점검합니다.",
          "OPS 컴퓨터 스펙: Intel Core i5/i7, 16GB RAM, 256GB SSD를 탑재하여 Windows 11을 단독 구동합니다.",
          "무상 A/S 보증 기간: 구매일 기준 기본 1년(프로모션 적용 시 최대 2년) 무상 출장 점검 서비스를 제공합니다.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "손가락 제스처 빠른 참조",
        body: "판서 화면에서는 손가락 개수에 따라 동작이 달라집니다. 펜과 손가락을 함께 쓰면 설명을 끊지 않고 판서와 조작을 오갈 수 있습니다.",
        steps: [
          "한 손가락(한 점): 필기와 클릭에 사용합니다. 글씨를 쓰거나 버튼·메뉴를 선택할 때 씁니다.",
          "두 손가락(두 점): 화면 스크롤에 사용합니다. 판서 페이지나 자료를 위아래로 이동할 때 씁니다.",
          "네 손가락(네 점): 펜 도구(UI) 호출에 사용합니다. 화면 어디서나 펜·지우개 같은 도구 모음을 바로 띄울 수 있습니다.",
          "손바닥처럼 넓은 면이나 지우개로 문지르면 필기를 지울 수 있습니다.",
          "제스처 동작은 모델과 펌웨어 버전에 따라 다를 수 있으니 수업 전에 실제 기기에서 한 번 확인합니다.",
        ],
      },
      {
        heading: "캔버스와 수업 흐름",
      ...
      {
        heading: "터치가 이상할 때 확인 포인트",
        body: "적외선 터치 방식의 특성상 터치 문제는 대부분 화면 테두리와 설치 환경에서 원인을 찾을 수 있습니다. 장비 문제로 판단하기 전에 아래 항목을 먼저 확인하세요.",
        steps: [
          "제스처가 의도대로 동작하지 않으면 화면 테두리(베젤)에 손이 닿았는지, 이물질이 끼지 않았는지 확인합니다.",
          "베젤에 먼지나 이물질이 끼면 터치가 튈 수 있으므로 주기적으로 닦아 줍니다.",
          "강한 직사광선이나 적외선 광원이 화면을 직접 비추면 터치 인식이 불안정해질 수 있어 설치 각도를 조정합니다.",
          "수업 중 잠깐 화면을 닦아야 하면 터치 잠금을 먼저 켜고, 본격적인 청소는 전원을 끈 뒤 부드러운 반건조 천으로 진행합니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "설치 직후·장비 변경 후 검수",
        body: "카메라나 마이크를 새로 설치했거나 구성을 바꿨다면, 수업에 투입하기 전에 실제 수업 흐름 그대로 한 번 검수하는 것이 좋습니다. 수업 직전 5분 점검과 달리, 이 단계에서는 저장과 기록까지 확인합니다.",
        steps: [
          "카메라와 마이크가 Classin에서 올바른 장치로 잡히는지 확인합니다.",
          "녹화가 필요한 경우 테스트 수업을 종료한 뒤 영상과 판서 자료 저장을 확인합니다.",
          "네트워크 설정, 카메라 IP, CMS 설정 변경 사항을 기록해 인수인계 자료로 남깁니다.",
          "설치 후 첫 주에는 실제 수업에서 발견된 문제를 모아 재점검합니다.",
        ],
      },
      {
        heading: "전용 카메라·마이크로 확장이 필요한 경우",
        body: "보드 기본 구성으로 수음이나 촬영이 부족한 큰 교실, 토론형 수업, 발표 중심 수업은 전용 장비를 함께 검토할 수 있습니다.",
        steps: [
          "보드 내장 마이크(8배열)로 부족한 대형 공간이나 토론형 수업은 천장형 마이크 ClassIn Mic DT2 Pro로 보완합니다. 단일 마이크 최적 면적은 60~80㎡입니다.",
          "강사가 이동하며 수업하는 장면을 안정적으로 담으려면 강사용 추적 카메라 ClassIn Cam T1을 검토합니다. 강사가 칠판 앞을 오가도 화면 가운데에 계속 잡아 줍니다.",
          "일어서서 발표하는 학생을 자동으로 화면에 담으려면 학생용 추적 카메라 ClassIn Cam S1을 검토합니다.",
          "세부 구성과 설치 조건은 'ClassIn Mic DT2 Pro 천장 마이크 가이드'와 'ClassIn Cam T1·S1 추적 카메라 가이드'에서 확인합니다.",
        ],
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          "전원은 100~240V를 사용하며 대기 전력은 0.5W 미만입니다.",
          "확인된 최대 소비전력은 S75 315W, S86 390W, S98 Pro 740W, S110 850W이며, S65 상세 소비전력은 최신 규격 확인 전까지 단정하지 않습니다. 멀티탭 정격 용량은 여유 있게 잡습니다.",
          "적외선 터치 방식이라 화면 테두리(베젤)에 먼지나 이물질이 끼면 터치가 튈 수 있으므로 주기적으로 닦아 줍니다.",
          "강한 직사광선이나 적외선 광원이 화면을 직접 비추면 터치 인식이 불안정해질 수 있어 설치 각도를 조정합니다.",
    ...
    sections: [
      {
        ...
        media: [
          {
            type: "image",
            src: "/images/docs/diagrams/install-flow.svg",
            alt: "PC 설치 3단계 흐름 다이어그램: 공식 홈페이지 다운로드 페이지에서 설치 파일을 받고, 내려받은 파일을 실행해 설치를 완료한 뒤, 클래스인 계정으로 로그인하는 순서",
            caption: "다운로드 → 설치 파일 실행 → 로그인, 세 단계면 설치가 끝납니다.",
            width: 1440,
            height: 760,
          },
        ],
      ...
      },
      {
        ...
        steps: [
          ...
          "경로: 공식 홈페이지 > [다운로드]",
          "칩에 맞는 맥용 설치 파일을 내려받습니다. (Intel → 인텔 프로세서 버전, M1·M2 → Apple Silicon 버전)",
          "다운로드한 설치 파일을 실행하여 클래스인 설치를 완료합니다.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          "경로: 플레이 스토어 > 검색창 '클래스인(Classin)' > [설치]",
          "검색 결과에서 '클래스인(Classin)'을 선택한 후 [설치] 버튼을 클릭합니다.",
      ...
      {
        heading: "확인 포인트",
        body: "스토어 검색 결과에는 비슷한 이름의 앱이 함께 나올 수 있으니, 설치 전에 아래 항목을 확인해 주세요.",
        steps: [
          "검색 결과에서 ClassIn 앱 이름과 아이콘을 확인한 뒤 설치합니다.",
          "설치가 되지 않으면 저장 공간, 운영체제 버전, 네트워크 상태를 먼저 확인합니다.",
          "설치가 끝나면 앱을 실행하고 기존 계정으로 로그인하거나 회원 가입을 진행합니다.",
        ],
      },
      {
        heading: "함께 보면 좋은 흐름",
        body: "설치 후 첫 실행에서는 기존 계정으로 로그인하거나 회원 가입을 진행합니다. 아직 계정이 없다면 회원 가입 문서를 함께 확인해 주세요.\n\nPC(윈도우·맥·리눅스)에서 수업을 진행하거나 참여할 예정이라면, 공식 다운로드 페이지에서 PC용 설치 파일도 받을 수 있습니다. OS와 칩셋에 맞는 파일 선택 방법은 PC 설치 문서에서 안내합니다.",
      },
    ],
    resources: [
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "확인 포인트",
        body: "가입 과정에서 자주 놓치는 항목입니다. 인증이 진행되지 않거나 가입이 완료되지 않을 때 먼저 확인해 주세요.",
        steps: [
          "휴대폰 번호로 가입할 때는 국가 번호가 올바르게 선택되어 있는지 확인합니다.",
          "인증코드 수신 여부를 확인하고, 비밀번호와 이름 등 화면에 표시된 필수 계정 정보를 빠짐없이 입력합니다.",
          "필수 약관을 확인한 뒤 회원 가입을 완료합니다.",
          "가입한 계정으로 로그인한 뒤 이름과 프로필 정보가 맞는지 확인합니다.",
        ],
      },
      {
        heading: "자주 묻는 상황",
        body: "인증코드 수신이 어려운 경우, 클래스인 공식 홈페이지 하단의 채팅을 통해 인증 코드를 요청할 수 있습니다.\n\n가입 후 비밀번호를 잊었다면 로그인 화면에서 비밀번호를 다시 설정할 수 있습니다. PC는 로그인 화면 하단의 [비밀번호 변경], 모바일은 [비밀번호를 잊으셨나요?] 메뉴를 이용하며, 자세한 절차는 비밀번호 변경 문서에서 안내합니다.",
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "1단계: 프로그램 실행",
        body: "클래스인 실행 후 로그인 화면 하단의 [비밀번호 변경]을 클릭해 주세요.",
        steps: [
          "PC에서 클래스인을 실행합니다.",
          "경로: 로그인 화면 하단 > [비밀번호 변경]",
        ],
      },
      {
      ...
      {
        heading: "확인 포인트",
        body: "비밀번호 변경 후 다시 로그인이 되지 않을 때는 아래 항목을 먼저 확인해 주세요.",
        steps: [
          "휴대폰 번호로 로그인할 때는 국가코드 드롭다운을 확인합니다. 기본값이 +1로 되어 있다면 한국 번호는 +82로 변경합니다.",
          "로그인 버튼이 회색(비활성) 상태라면 아이디와 암호가 모두 입력되었는지 확인합니다.",
          "모바일 기기에서 변경하는 경우 절차가 일부 다르므로 비밀번호 변경 (모바일) 문서를 확인합니다.",
        ],
      },
    ],
    resources: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "1단계: 프로그램 실행",
        body: "클래스인 실행 후 로그인 화면 하단의 [비밀번호를 잊으셨나요?]를 클릭해 주세요.",
        steps: [
          "모바일에서 클래스인을 실행합니다.",
          "경로: 로그인 화면 하단 > [비밀번호를 잊으셨나요?]",
        ],
      },
      {
        heading: "2단계: 인증코드 발송 및 신규 비밀번호 설정",
      ...
      {
        heading: "자주 묻는 상황",
        body: "인증코드 수신이 어려운 경우, 클래스인 공식 홈페이지 하단의 채팅을 통해 인증 코드를 요청할 수 있습니다.\n\n재로그인 시 [약관 동의] 체크는 모바일 기기에만 해당하는 절차입니다. 체크하지 않으면 로그인이 되지 않으므로, 로그인이 진행되지 않을 때 가장 먼저 확인해 주세요.\n\nPC에서도 비밀번호를 변경할 수 있습니다. PC는 로그인 화면 하단의 [비밀번호 변경] 메뉴를 이용하며, 자세한 절차는 비밀번호 변경 (PC) 문서를 참고해 주세요.",
      },
    ],
    ...
    sections: [
      {
        ...
        body: "클래스인은 전자칠판, EDB 교안, 자동 녹화, LMS(코스·출결·과제·성적), 학생관리, 관리자 운영 데이터를 하나의 수업 운영 흐름으로 묶는 수업 시스템 OS입니다. 무료 버전은 체험 용도라 수업 녹화·웹 라이브 같은 운영 핵심 기능이 제한됩니다.\n\n유료 전환의 목적은 '기능을 더 켜는 것'이 아니라, 수업 전·중·후 운영을 한 흐름으로 돌려서 교사와 운영팀의 반복 업무를 줄이는 데 있습니다. 전환을 결정하기 전에 '우리 학원이 매주 반복으로 돌릴 수업 흐름이 무엇인지'를 먼저 정해 두면 요금제 선택과 도입 속도가 모두 빨라집니다.",
      },
      {
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "인증 절차",
        body: "주 관리자 계정으로 로그인한 뒤 계정 정보 메뉴에서 인증 자료를 입력하고 증명서를 업로드합니다.",
        steps: [
      ...
      {
        heading: "자주 하는 실수와 확인 포인트",
        body: "인증 단계에서 반복되는 문제는 대부분 자료 준비와 정보 불일치에서 생깁니다. 업로드 전에 아래 항목을 점검하면 반려로 인한 재작업을 줄일 수 있습니다.",
        steps: [
          "유료 전환 직후 바로 인증을 진행합니다. 인증을 미루면 수업 녹화·웹 라이브 같은 제한 기능이 계속 막혀 있습니다.",
          "유료 전환 때 입력한 학원명·소재지가 인증 서류와 다르면 인증이 반려될 수 있으므로, 처음부터 인증 서류 기준으로 동일하게 입력합니다.",
          "증명서 파일은 JPG 또는 PNG / 5MB 이하, 브랜드 로고는 260*90px / 1MB 이하 요건을 업로드 전에 확인합니다.",
          "인증 절차는 주 관리자 계정으로 로그인해 진행하므로, 운영 담당자가 여러 명이라면 주 관리자 계정 접근을 먼저 확인합니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "기본 설정",
        body: "학원 전체에 적용되는 기본 정보를 관리합니다.",
        steps: [
          "경로: 대시보드 좌측 메뉴 > [일반 설정] > [기본 설정]",
          "코스 기본 커버와 브랜드 로고를 변경합니다. 신규 코스 모두에 자동 적용됩니다.",
          "학교 소개를 작성하면 학습 보고서 등에 표시됩니다.",
        ],
      },
      {
        heading: "교실 설정",
      ...
      },
      {
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/새로-들어온-학생도-수업-다시보기-시청.png",
            alt: "관리자 대시보드 계정 정보 → 일반 설정 → 수업 다시보기 탭에서 신규 참여 학생의 이전 수업 다시보기 허용 옵션을 켜는 화면",
            caption: "일반 설정 → [수업 다시보기]에서 신규 참여 학생의 이전 수업 열람을 허용하는 화면",
            width: 1440,
            height: 2357,
          },
        ],
      ...
      {
        heading: "부가가치 서비스",
        body: "부가가치 서비스로 다음 세 가지를 제공합니다. Nobook과 슈퍼 고객 서비스는 국내 미제공입니다.\n\n- AI 에이전트: LMS 내 AI 기능, 한시적 무료\n- 하이브리드 수업: 학생이 칠판 화면과 현장 카메라 화면 중 원하는 뷰를 선택, 요금제별 제한 가능\n- 스마트 담임 교사 SMS 알림: 구독형 또는 충전형(연 2,988CNY + 메시지당 약 0.2CNY)",
      },
      {
        heading: "저장 설정",
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/클래스인-스토리지-삭제-안내.png",
            alt: "관리자 대시보드 일반 설정 → 저장 설정에서 리소스 자동 삭제 옵션을 켜고 삭제 작업을 생성하는 화면 — 삭제 시 복구 불가 경고 포함",
            caption: "저장 설정의 자동 삭제 옵션과 삭제 작업 생성 화면 — 서버 데이터 삭제라 복구가 불가능하니 신중히 진행하세요",
            width: 1551,
            height: 3543,
          },
        ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "권한은 '있으면 편하다'가 아니라 '이 강사의 역할에 필요한가' 기준으로 줍니다. 직접 코스를 설계하고 운영하는 강사에게만 코스 생성 권한을 주고, 배정된 수업만 진행하는 강사는 등록 상태로 두는 것이 깔끔합니다. 직접 코스를 만들어야 하는 강사라면 하위 계정으로 추가하고 '공개 수업 및 클래스 만들기' 권한을 허용합니다.",
        steps: [
          "강사를 두 부류로 나눕니다. 직접 코스를 만드는 강사와 배정된 수업만 진행하는 강사입니다.",
          "경로: 계정 정보 > 권한 관리 > [하위 계정 추가]",
          "직접 코스를 만드는 강사를 하위 계정으로 등록합니다.",
  ...
  },
  {
    ...
    sections: [
      {
        heading: "개별 학생 추가",
        body: "이름과 아이디(핸드폰 번호 또는 이메일)를 입력해 학생을 한 명씩 등록합니다.",
        steps: [
          "경로: 기관 관리 > 학생 > [학생 추가]",
          "이름과 아이디(핸드폰 번호 또는 이메일)를 입력합니다.",
          "필요 시 학번, 태그 등 선택 정보를 함께 입력하고 저장합니다.",
        ],
      },
      {
        heading: "텍스트 가져오기 (회당 100명)",
        body: "1회당 최대 100명까지 등록할 수 있습니다. 형식은 82-1012345678#홍길동 또는 example@gmail.com#임꺽정과 같이 아이디#이름 형태로 작성합니다.",
        steps: [
          "경로: 기관 관리 > 학생 > [학생 추가] > [텍스트에서 가져오기]",
      ...
      },
      {
        ...
        body: "템플릿(예: '[클래스인] 학생 등록 양식.xlsx')을 다운로드한 뒤 1회당 최대 300명까지 일괄 등록할 수 있습니다. 1행은 그대로 두고 2행부터 학생 정보를 기입해야 합니다.",
        steps: [
          "경로: 기관 관리 > 학생 > [학생 추가] > [Excel 가져오기]",
      ...
      },
      {
        ...
        body: "학생이 직접 가입하기 어려운 경우 팝업에서 [학생 대리 등록] 옵션을 체크하면 입력한 핸드폰 번호 또는 이메일이 그대로 ID로 설정됩니다. SMS(핸드폰) 또는 이메일로 임시 비밀번호가 포함된 안내가 발송됩니다. 학생은 로그인 후 비밀번호를 변경할 수 있습니다.",
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/클래스인-학생-대리등록-코스-입장.png",
            alt: "코스 구성원에서 학생 추가 팝업의 학생 대리 등록 옵션을 체크하고 아이디#이름 형식으로 입력해 새 계정을 생성하는 화면",
            caption: "학생 추가 팝업에서 [학생 대리 등록]을 체크해 ID를 생성하는 화면 — '82-1012345678#홍길동' 형식 입력 예시 포함",
            width: 1440,
            height: 4132,
          },
        ],
      ...
      {
        heading: "등록 후 확인 포인트",
        body: "학생 등록은 계정을 만드는 것으로 끝나지 않습니다. 코스 배정까지 이어져야 학생이 실제 수업에 참여할 수 있습니다.",
        steps: [
          "코스에 학생을 배정하려면 먼저 학원(기관) 대시보드에 등록되어 있어야 합니다. 등록을 마친 뒤 코스의 구성원 설정에서 학생을 배정합니다.",
          "대리 등록한 학생에게는 SMS 또는 이메일로 임시 비밀번호가 발송되므로, 첫 로그인 후 비밀번호를 변경하도록 안내합니다.",
          "학생이 본인이 소속된 반과 수업에만 접근할 수 있도록 정기적으로 점검합니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "코스 추가하기",
        body: "기관 관리의 코스 관리에서 새 코스를 만들고 담임 교사와 교사를 지정합니다. 담임 교사는 코스·수업 생성과 편집, 구성원 관리 권한을 갖습니다.",
        steps: [
          "경로: 기관 관리 > 코스 관리 > [코스 만들기]",
          "코스명을 입력합니다.",
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          "수업 데이터를 외부 시스템으로 옮길 때: 결제·오프라인 출결 정산이나 고급 리포트 가공이 필요하면 Classin 내부에서 무리하게 처리하기보다, 내보낸 데이터를 별도 시스템에서 다루는 방식을 검토합니다.",
          "필요 시 상담으로 적합한 연동 방법을 확인합니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "스토리지 사용량 확인",
        body: "기관의 스토리지 사용량과 전체 용량을 확인할 수 있습니다. 기본 제공 용량, 무료 보관 기간, 추가 용량 단가, 클래스 파일 분류 기준은 최신 계약·기관 설정으로 확인합니다.",
        steps: [
          "경로: 스토리지 > [데이터 개요]",
          "수업 리소스, 코스 첨부 파일, 공유 드라이브, 게시판 문서, 전체 합계로 구분된 항목별 사용량을 확인합니다.",
        ],
      },
      {
        heading: "수업 리소스 검색",
      ...
      },
      {
        ...
        body: "1분마다 자동 저장된 스크린샷을 확인·저장할 수 있고, 참여자(교사·학생)의 출결 여부와 입장/퇴장 기록을 함께 조회할 수 있습니다.",
        steps: [
          "경로: 스토리지 > 수업 리소스 > 오퍼레이션 > [수업 스크린샷]",
          "확인할 수업의 스크린샷과 참여자의 입장/퇴장 기록을 조회합니다.",
        ],
      },
      {
        heading: "수업 녹화본 관리",
        ...
        media: [
          {
            ...
            alt: "관리자 대시보드 수업 리소스에서 녹화된 수업 비디오를 열어 클립을 다운로드하고 재생 링크를 복사해 공유하는 화면",
            caption: "수업 리소스 → 녹화된 수업 비디오에서 클립을 다운로드하고 재생 링크로 공유하는 화면",
            width: 1440,
            height: 2000,
          },
        ],
      ...
      {
        heading: "삭제 전 확인 포인트",
        body: "스토리지 정리는 용량 확보에 필요하지만, 수업 데이터 삭제는 복구가 불가능합니다. 정리 작업 전에 아래 항목을 점검하면 필요한 기록을 잃는 사고를 막을 수 있습니다.",
        steps: [
          "수업 데이터(스크린샷·녹화 동영상·칠판 내용 등)는 삭제 후 복구할 수 없으므로, 보관이 필요한 항목은 먼저 다운로드하거나 보호 잠금을 설정합니다.",
          "일괄 삭제는 보호 잠금이 해제된 수업에만 적용됩니다. 지우면 안 되는 수업은 삭제 전에 보호 잠금 상태를 확인합니다.",
          "자동 삭제 설정을 사용할 때는 권한 범위와 복구 가능 여부를 먼저 확인합니다.",
          "코스 종료를 앞둔 반은 종료 전에 필요한 녹화본과 학습 보고서를 미리 확보합니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      {
        heading: "공유 드라이브 생성",
        body: "폴더명을 입력해 공유 드라이브를 생성합니다. 폴더명은 언제든 수정할 수 있고 구성원 초대와 권한 설정을 함께 진행할 수 있습니다.",
        steps: [
          "경로: 스토리지 > 공유 드라이브 > [공유 드라이브 만들기]",
          "폴더명을 입력합니다.",
      ...
      },
      {
        ...
        body: "구글 드라이브를 연동하면 구글 드라이브 자료를 온라인 교실에서 바로 활용할 수 있습니다.",
        steps: [
          "경로: PC 클래스인 앱 > [드라이브] > [Google Drive]",
          "메뉴를 클릭해 구글 드라이브를 연동합니다.",
          "연동된 구글 드라이브 자료를 온라인 교실에서 바로 활용합니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "웹 라이브 수업을 만드는 위치",
        body: "웹 라이브는 라이브&플레이백 메뉴에서 새로 만드는 것이 아니라, 수업을 생성할 때 옵션으로 켭니다. 웹 라이브 기능을 사용하려면 수업 녹화 옵션을 최소 1개 활성화해야 합니다.",
        steps: [
          "경로: 코스 내부 > [시간표] > [수업 생성]",
          "수업 녹화 옵션을 1개 이상 활성화합니다.",
          "[웹 라이브 & 플레이백] 옵션을 켜고 시청 권한, 로그인/비밀번호, 채팅, 커버 이미지, 소개 같은 세부 옵션을 수업 성격에 맞게 설정한 뒤 [게시하기]를 클릭합니다.",
          "[시간표]에서 생성된 수업의 웹 라이브 & 플레이백 링크를 확인하고 QR 또는 웹 링크로 복사합니다.",
        ],
      },
      {
        heading: "수업 링크 확인 및 공유",
        body: "대시보드의 라이브&플레이백 메뉴에서 웹 참여 링크를 확인·복사해 재원생이나 외부 참여자에게 공유할 수 있습니다.",
        steps: [
          "경로: 대시보드 > [라이브&플레이백] > [웹 페이지 링크]",
          "참여 링크를 확인하고 복사합니다.",
          "복사한 링크를 재원생 또는 외부 참여자에게 공유합니다.",
        ],
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/웹-라이브-사용-방법-안내-대시보드.png",
            alt: "관리자 대시보드 코스 관리에서 수업을 생성해 웹 라이브 & 플레이백을 켜고 시간표에서 QR·웹 링크를 복사한 뒤 관리 메뉴에서 시청 데이터를 확인하는 단계별 화면",
            caption: "대시보드에서 웹 라이브를 만들고 QR·웹 링크를 복사해 공유하는 흐름",
            width: 1440,
            height: 4700,
          },
        ],
      ...
      },
      {
        ...
        body: "수업 종료 후 관리 메뉴에서 시청 통계를 확인할 수 있습니다.",
        steps: [
          "경로: [라이브&플레이백] > [오퍼레이션] > [관리]",
          "시청자 수, 좋아요 수 등 통계를 확인합니다.",
        ],
      },
      {
        heading: "확인 포인트",
        body: "웹 라이브는 링크만 있으면 앱 설치 없이 참여할 수 있는 만큼, 공개 범위와 제공 기준을 먼저 정해 두는 것이 안전합니다.",
        steps: [
          "계정 인증이 완료되지 않은 계정은 수업 녹화·웹 라이브 기능이 제한됩니다. 기능이 보이지 않으면 계정 인증 상태를 먼저 확인합니다.",
          "다시보기 제공 범위와 제공 기간은 반별 운영 정책으로 명확히 정해 둡니다.",
          "외부 공개가 목적이 아니라면 로그인 요구·비밀번호 시청 보호를 설정해 외부 공유 리스크를 줄입니다.",
          "수업별 실시간 시청 현황과 종료 후 다시보기 상태는 코스·수업 관리의 조작 메뉴(웹 라이브 및 다시보기 관리)에서도 확인할 수 있습니다.",
        ],
      },
    ],
    ...
    sections: [
      {
        ...
        body: "수업 모니터링은 진행 중인 수업이 정상적으로 굴러가는지 관리자가 운영 관점에서 확인하는 기능입니다. Classin은 전자칠판, EDB 교안, 녹화, LMS, 학생관리, 관리자 데이터가 하나의 수업 운영 흐름으로 이어지는 수업 시스템 OS입니다. 수업 모니터링은 그 흐름에서 '수업 중' 단계가 막힘 없이 돌아가는지를 관리자가 권한 범위 안에서 보는 역할을 합니다. 화면을 몰래 캡쳐하거나 교사를 평가하기 위한 감시 도구가 아니라, 입장이 안 되거나 소리·화면이 끊긴 수업을 빨리 찾아 돕기 위한 운영 데이터 가시성으로 이해하면 됩니다.",
        steps: [
      ...
      },
      {
        ...
        steps: [
          "경로: 관리자 기능 > 수업 모니터링",
          "진행 중인 수업 목록에서 수업별 교사·학생 출석 여부와 접속 인원을 먼저 확인합니다.",
    ...
    sections: [
      ...
      },
      {
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/관리자-대시보드-현재-수업-진행.png",
            alt: "관리자 대시보드에서 결제 → 결제 개요의 일자별 비용 내역과 결제 → 통계 다운로드의 수업 소비 Excel 다운로드를 확인하는 화면",
            caption: "결제 → [통계 다운로드]에서 수업 소비 데이터를 Excel로 내려받는 화면 (결제 개요의 일자별 비용 확인 포함)",
            width: 1551,
            height: 3643,
          },
        ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "자주 묻는 상황",
        body: "코스 설정은 PC뿐 아니라 모바일 앱에서도 접근할 수 있습니다. 어느 쪽에서든 같은 코스를 보는 것이므로, 상황에 맞는 기기에서 정리하면 됩니다.",
        steps: [
          "모바일 앱에서는 홈에서 대상 코스로 들어간 뒤, 코스 상세 화면 상단 코스 정보 카드 우측의 화살표(>)를 눌러 코스 설정으로 이동합니다.",
          "모바일 코스 설정 하단의 [코스 종료/클래스 탈퇴] 항목에서 코스 종료를 진행할 수 있습니다.",
          "코스 설정에서는 코스 구성원 확인, 코스 소개 설정, 코스 내 나의 닉네임 변경, 채팅방 상단 고정, 알림 끄기 등을 함께 조정할 수 있습니다.",
          "PC에서는 코스를 없애지 않고 본인만 나가야 할 때 코스 설정 하단의 [코스 나가기]를 사용합니다.",
        ],
      },
      {
        heading: "코스 구성 살펴보기",
      ...
      {
        heading: "폐강 전 확인 포인트",
        body: "폐강은 코스 운영을 마무리하는 절차인 만큼, 종료 전후로 아래 항목을 한 번씩 확인해 두면 안전합니다.",
        steps: [
          "코스 종료 전에 구성원과 수업 자료의 접근 범위가 어떻게 달라지는지 확인합니다.",
          "보관이 필요한 자료는 종료 전에 미리 정리해 둡니다.",
          "종료 안내와 데이터 접근 영향을 확인한 뒤 최종 확인을 진행합니다.",
          "폐강 후에는 코스 목록에서 상태가 종료됨으로 바뀌었는지 확인합니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "확인 포인트",
        body: "초대·역할 변경·퇴장은 모두 코스 구성원 목록에서 이뤄집니다. 처리 전후로 대상과 결과를 한 번씩 확인하는 습관을 들이면 실수를 줄일 수 있습니다.",
        steps: [
          "구성원은 직접 추가할 수도 있고, QR 코드나 초대 링크를 전달해 사용자가 직접 입장하게 할 수도 있습니다.",
          "구성원을 삭제하기 전에는 사용자 이름과 교사·학생 역할을 먼저 확인합니다. 담임 교사나 운영 담당자를 잘못 삭제하지 않도록 주의합니다.",
          "추가 또는 삭제 후에는 구성원 수와 역할이 의도대로 반영됐는지 확인합니다.",
        ],
      },
      {
        heading: "함께 보면 좋은 흐름",
        body: "기관 관리자는 코스 화면 밖에서도 구성원을 관리할 수 있습니다. 관리자 대시보드의 기관 관리 > 코스 관리에서 코스 이름을 눌러 코스 상세 화면을 열면 편입생(참관생)을 추가하고, 편입생 목록에 반영됐는지까지 확인할 수 있습니다.\n\n코스 운영이 끝나 구성원 정리가 필요한 경우에는 코스 종료(폐강) 절차를 함께 확인하세요.",
      },
    ],
    ...
    sections: [
      {
        ...
        media: [
          {
            type: "image",
            src: "/images/docs/diagrams/lesson-options.svg",
            alt: "수업 생성 옵션 4종 구분 다이어그램: 수업 녹화, 현장 녹화, 온스테이지, 하이브리드 수업의 목적 차이 — 두 녹화 뷰는 다시보기에서 선택",
            caption: "이름이 비슷한 네 옵션은 목적이 서로 다릅니다.",
            width: 1440,
            height: 760,
          },
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/웹-라이브-사용-방법-안내-앱.png",
            alt: "클래스인 앱에서 새로 만들기로 수업을 생성하고 녹화 옵션과 웹 라이브를 활성화한 뒤 게시해 링크를 확인하는 단계별 화면",
            caption: "앱에서 웹 라이브 수업을 생성하는 전체 흐름 — 녹화 옵션을 켜야 웹 라이브·플레이백을 쓸 수 있습니다",
            width: 1440,
            height: 8175,
          },
        ],
      ...
      },
      {
        ...
        body: "수업이 끝나면 대시보드에서 시청자 수, 좋아요 수 등 운영 데이터를 확인할 수 있습니다.",
        steps: [
          "경로: 대시보드 > [라이브&플레이백] > [오퍼레이션] > [관리]",
          "시청자 수, 좋아요 수 등 운영 데이터를 확인합니다.",
        ],
      },
      {
        heading: "자주 묻는 질문 · 요금",
        body: "구독(Classin Learning Space) 요금제에서는 enterprise에서만, 충전(Consumption) 요금제에서는 business에서만 웹 라이브를 사용할 수 있습니다. Business Consumption 요금 예시는 다음과 같으며, Enterprise는 별도 요금이 없습니다.\n\n- PC 720P: 시간당 0.8위안/1인(최대 270MB)\n- PC 1080P: 시간당 2.1위안/1인(최대 720MB)\n- 전자칠판 720P: 시간당 1.2위안/1인(최대 405MB)\n- 전자칠판 1080P: 시간당 3.2위안/1인(최대 1080MB)",
      },
    ],
    ...
    sections: [
      ...
      },
      {
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/클래스인-교실-내-카메라-마이크-설정-확인-pc.png",
            alt: "교실 우측 상단 아이콘 또는 설정 메뉴에서 마이크·스피커·카메라를 선택하고 테스트하는 설정 화면",
            caption: "교실 내 카메라·마이크 설정 확인 화면 — 사운드 바가 초록색으로 움직이는지, 연결된 카메라가 맞는지 확인합니다",
            width: 2330,
            height: 5213,
          },
        ],
      ...
      },
      {
        ...
        steps: [
          "경로: 우측 상단 [메뉴] > [설정]",
          "스테이지: [일반]에서 스테이지 표시 여부를 변경합니다.",
          "가상 배경: [가상 배경]에서 원하는 배경을 선택합니다.",
          "교실 배경: [교실 배경]에서 배경을 선택하거나 직접 제작한 이미지를 업로드합니다.",
        ],
      },
      {
  ...
  },
  {
    ...
    sections: [
      {
        heading: "채팅 목록 열기",
        body: "홈 화면 왼쪽 사이드바에서 [채팅] 탭을 누르면 내가 속한 코스별 채팅창이 모여 있는 목록이 표시됩니다. 원하는 코스를 클릭하면 해당 코스 채팅창이 열립니다. 모바일 앱에서는 하단 탭 바의 [채팅]에서 같은 목록을 확인할 수 있습니다.",
        steps: [
          "경로: 왼쪽 사이드바 > [채팅]",
      ...
      {
        heading: "임시 교실 개설",
        body: "채팅창에서 최대 15분간 진행 가능한 임시 교실을 바로 열 수 있습니다. 질문 논의나 짧은 면대면 소통이 필요할 때 유용합니다.",
        steps: [
          "경로: 코스 채팅창 > 채팅 입력창 하단 아이콘 줄 > [임시 교실]",
          "수업 이름과 게시 설정의 참여 구성원을 설정합니다.",
          "생성을 완료하면 참여 구성원이 자동으로 맨션되고, 채팅에 '수업 입장' 카드가 게시되어 바로 수업을 시작할 수 있습니다.",
        ],
      },
      {
        heading: "연락처 및 친구 관리",
      ...
      {
        heading: "확인 포인트",
        body: "채팅을 쓰기 전에 알아 두면 좋은 사항입니다.",
        steps: [
          "채팅에서 표시되는 이름은 프로필 닉네임입니다. 친구·선생님이 나를 구분하는 식별 정보이므로 학원이 지정한 양식을 유지합니다.",
          "파일은 로컬 또는 클라우드 드라이브에서 첨부할 수 있고, 드라이브에 올려 둔 파일은 채팅에서 그대로 재사용할 수 있습니다. 단, 드라이브에는 200MB를 초과하는 파일은 올릴 수 없습니다.",
          "수업 중에도 교사가 권한을 주면(이름 옆 왕관 표시) 이모티콘·@태그·파일 첨부·연락처 공유·임시 교실 개설 기능을 사용할 수 있습니다.",
        ],
      },
    ],
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: "스마트폰과 태블릿에서는 앱 하단 내비게이션 바에 [할 일]과 [캘린더] 탭이 있어, 이동 중에도 동일한 화면으로 일정을 확인하고 관리할 수 있습니다.",
      },
      {
        heading: "함께 보면 좋은 흐름",
        body: "[할 일]과 [캘린더]는 일정을 확인하는 데서 끝나지 않고, 수업 입장과 활동 제출로 바로 이어집니다.",
        steps: [
          "실시간 수업은 [코스] 또는 [할 일] 탭에서 해당 수업의 교실 입장 버튼을 직접 클릭해 들어갈 수 있습니다.",
          "과제·시험은 각 활동의 [숙제하기]·[제출하기]·[응시하기] 버튼으로 이어서 제출·응시합니다.",
          "제출한 활동의 점수와 피드백은 코스의 [성적] 화면에서 확인합니다.",
        ],
      },
      {
        heading: "자주 묻는 상황",
        body: "마감 관리와 관련해 학생들이 자주 묻는 내용입니다.",
        steps: [
          "숙제는 제출 후에도 수정할 수 있지만, 수정하면 점수와 피드백이 초기화되니 주의합니다.",
          "일일 과제는 선생님이 지정한 날짜마다 자동으로 제공되므로, [할 일]에서 새 항목이 생겼는지 수시로 확인합니다.",
          "토론 활동은 참여 기한이 설정될 수 있고, 누군가 답변을 남기면 알림이 옵니다.",
          "찾는 항목이 보이지 않으면 상단 드롭다운 필터가 특정 코스나 카테고리로 좁혀져 있지 않은지 먼저 확인합니다.",
        ],
      },
    ],
        ...
        media: [
          {
            ...
            alt: "모바일 앱 홈 우측 상단 + 메뉴에서 QR 코드 스캔을 선택한 뒤 코스 정보 화면에서 코스 가입 버튼을 누르는 3단계 화면",
            caption: "모바일 앱에서 QR 코드 스캔으로 코스에 가입하는 화면",
            width: 1440,
            height: 6325,
          },
        ],
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/클래스인-교실-내-카메라-마이크-설정-확인-pc.png",
            alt: "클래스인 교실 설정 창에서 마이크 사운드 바와 카메라 미리 보기·기기 드롭다운을 확인하는 PC 화면",
            caption: "교실 안 설정 창에서 카메라·마이크·스피커를 확인하는 화면 (PC)",
            width: 2330,
            height: 5213,
          },
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        media: [
          {
            type: "image",
            src: "/docs/files/cs-figma/숙제-업로드-모바일.png",
            alt: "모바일 앱에서 코스를 선택해 숙제의 제출하기를 누르고 하단 사진 아이콘으로 첨부해 제출하는 4단계 화면",
            caption: "모바일에서 숙제를 제출하는 화면 — 코스 선택 → [제출하기] → 사진 첨부 → 숙제 제출",
            width: 1440,
            height: 1974,
          },
        ],
    ...
    sections: [
      ...
      },
      {
        ...
        steps: [
          ...
          "'오프라인 수업 점수가 안 보인다': 클래스인 성적은 코스 안에서 진행된 활동을 기준으로 합니다. 오프라인에서 본 지필 시험 등은 교사가 별도로 입력하지 않으면 표시되지 않을 수 있습니다.",
          "통합 성적표가 필요하면 교사·학원에 문의하세요.",
        ],
      },
      {
  ...
  },
  {
    ...
    readMinutes: 6,
    featured: true,
    tags: ["도입 사례", "고객 후기", "학원 사례", "원장 후기", "강사 후기", "도입 효과", "레퍼런스", "사용하는 학원"],
    keywords: ["학원 도입 사례","우리 같은 학원 사례","비슷한 학원 사례","국어학원 사례","영어학원 사례","과학학원 사례","입시학원 사례","온라인 수업 사례","하이브리드 수업 사례","원장 후기","강사 후기","고객 후기","도입 후기","도입하면 뭐가 바뀌어요","도입 효과","사용하는 학원","사용하는 곳","다른 사용하는 곳","레퍼런스","레퍼런스 학원","도입 학원","설치 학원","어디서 사용","어느 학원","사용 중인 학원","실제 사용 학원"],
    ...
    sections: [
      ...
      { heading: "입시 전문 학원 — 휘발되던 판서·풀이를 복습 자산으로 남겼습니다", body: "고난도 수업일수록 판서와 풀이 과정이 그 자리에서 끝나버리면, 결석생이나 복습이 필요한 학생에게 같은 품질로 전달하기 어렵습니다.", steps: ["대치 세** (입시 전문, 상위권 집중 관리): 고난도 판서·풀이가 휘발돼 결석·복습 학생에게 같은 품질 전달이 어려웠으나, 실시간 판서와 수업 자료를 수업 흐름 안에 모아 복습 자료화와 보강 운영의 밀도를 높였습니다.","대구 학** (정규반·특강 병행): 강의 자료·출결·과제 안내를 한곳에 모아 강사와 운영팀이 같은 기준으로 학생을 관리하게 됐습니다.","평택 윤** (중·고등 운영): 분산돼 있던 수업 자료와 판서 기록을 클래스인 중심으로 정리해 수업 이후 복습 안내와 보강 관리를 더 빠르게 연결했습니다."] },
      ...
      { heading: "공통 변화 패턴 — 기록 누적 → 표준화 → 후속관리", body: "과목과 운영 형태는 달라도, 도입 학원들이 체감한 변화는 거의 같은 순서를 따릅니다. 먼저 판서·자료·첨삭·평가가 자동으로 기록으로 남습니다(기록 누적). 그 기록이 강사 개인기에 의존하던 수업을 기관의 반복 가능한 기준으로 바꿉니다(표준화). 마지막으로 누적된 데이터가 상담·복습·보강 같은 후속관리로 이어집니다(후속관리). 도입하면 뭐가 바뀌느냐는 질문에는 이 세 단계로 설명드리는 편이 가장 정확합니다.", steps: ["1단계 기록 누적: 판서·수업 화면·자료·첨삭·테스트 결과가 휘발되지 않고 수업 흐름 안에 남습니다.","2단계 표준화: 강사별로 달랐던 수업·피드백 방식이 기관 공통 기준으로 정리되고, 신규 강사 온보딩도 쉬워집니다.","3단계 후속관리: 누적 데이터로 상담 준비 시간이 줄고, 복습·보강 안내와 학생별 후속 관리가 빨라집니다.","도입 기간: 대부분 전자칠판 + 녹화 + 수업 관리의 스탠다드 구성으로 시작하며, 정착까지 평균 3개월(보통 3~4개월) 정도가 걸립니다."] },
  ...
  },
  {
    ...
    readMinutes: 6,
    featured: true,
    tags: ["도입 고민", "왜 필요", "전자칠판 차이", "줌 차이", "운영비", "강사 리소스", "수업 시스템 OS"],
    ...
    chatbotSummary: "클래스인은 새 기능을 더 사자는 제안이 아니라, 수업·녹화·교안·과제·학생 데이터가 강사 개인과 여러 도구에 흩어져 운영비와 강사 리소스를 잡아먹는 구조를 한 흐름으로 묶는 수업 시스템 OS입니다. 지금도 되는데, 전자칠판 있는데, 줌이면 충분이라는 고민은 모두 기능이 아니라 운영 흐름과 누적 리소스 관점에서 답합니다.",
    sections: [
  ...
  },
  {
    ...
    description: "클래스인 도입 비용을 단순 전자칠판 가격표와 비교하기 전에, 견적이 무엇으로 구성되는지와 통합 수업 시스템 OS 관점에서 무엇을 함께 따져야 하는지 정리했습니다. 정확한 금액과 계약 조건은 상담으로 안내합니다.",
    ...
    chatbotSummary: "클래스인 가격은 학원 규모·상황·패키지에 따라 다릅니다. Pro 요금제는 계정당 월 구독 형태(100인 동시 수업, LMS, 자동 녹화)이며, Enterprise 요금제는 커스텀 브랜딩, ERP/API 연동, 전담 CS 매니저를 지원합니다. ClassIn Board(전자칠판) 구매 시 소프트웨어 라이선스 최대 30% 결합 번들 할인이 적용되며, 문의 페이지(/contact)에서 맞춤 견적서를 바로 발급받으실 수 있습니다.",
    sections: [
  ...
  },
  {
    ...
    sections: [
      ...
      { heading: "4단계 정착 — 판서·녹화·복습·LMS로 이어지는 수업 루틴", media: [{ type: "image", src: "/images/docs/diagrams/adoption-routine.svg", alt: "수업 운영 루틴 루프 다이어그램: 전자칠판 판서에서 수업 녹화, 다시보기 복습, LMS 숙제·시험으로 이어진 뒤 다시 판서로 돌아오는 매주 반복 루틴", caption: "판서 → 녹화 → 다시보기 복습 → LMS 숙제·시험으로 매주 반복되는 정착 루틴입니다.", width: 1440, height: 760 }], body: "한국 학원의 스탠다드 도입은 전자칠판 판서 → 녹화 → 다시보기 복습 → LMS 숙제·시험으로 이어지는 흐름을 클래스인 안에서 해결하는 것입니다. 학생이 개인 기기를 잘 쓰지 않는 현장형 학원도 이 루틴은 현실적으로 적용할 수 있습니다.", steps: ["실시간 수업은 전자칠판 판서 중심으로 진행하고 자동 녹화 상태를 기본 점검 항목으로 둡니다.","결석 학생과 복습 대상 학생에게 녹화와 과제를 함께 안내하는 기준을 세웁니다.","숙제, 시험, 복습 자료를 클래스인 LMS 안에서 운영할 반을 정합니다.","강사가 녹화 업로드와 링크 배포를 수동으로 반복하지 않도록 흐름을 점검합니다.","수업 채팅과 피드백이 학생별 관리 기록으로 남게 합니다."] },
  ...
  },
  {
    ...
    sections: [
      { heading: "이 문서는 지도입니다", body: "앱으로 뭘 할 수 있어요?, 무슨 기능이 있어요?, ○○는 어디서 해요?에 한 번에 답하기 위한 전체 기능 지도입니다. 클래스인은 단순 전자칠판이나 화상 수업 도구가 아니라 수업·녹화·과제·학생 관리·데이터·권한 관리를 한곳으로 묶는 수업 시스템 OS입니다. 여기서는 큰 묶음만 빠르게 훑고, 세부 사용법은 각 묶음의 전용 문서로 연결합니다.", steps: ["학습 활동: 수업 전·후에 코스에 올리는 9종 활동을 만듭니다.","교실 도구: 실시간 수업 중에 꺼내 쓰는 30가지 이상의 도구입니다.","AI 기능: 활동 유형, 기관 설정, 계약 조건에 따라 채점·출제·첨삭과 AI 언어활동을 보조합니다.","관리자 데이터: 콘솔에서 권한 기반으로 수업 운영 데이터를 봅니다.","EDB·API: 교안 파일(EDB)과 외부 연동(API)으로 수업·운영을 확장합니다."] },
    ...
    sections: [
      {
        ...
        steps: [
          ...
          "ClassIn을 전자칠판 단품이 아니라 수업 시스템 OS 구성으로 설명합니다.",
      ...
      },
      {
        ...
        body: "도입 전 질문을 정리해 오면 상담은 훨씬 빨라집니다. 기능 시연보다 먼저 불안 요소를 좁혀야 정확한 견적과 도입 범위가 나옵니다.\n\n상담 요청에는 '우리 학원은 현재 ___ 때문에 ClassIn 도입을 검토하고 있습니다. 가장 확인하고 싶은 항목은 ___, ___, ___이고, 데모에서는 ___ 장면을 보고 싶습니다. 견적에는 ___까지 포함되는지 확인이 필요합니다.'처럼 적으면 됩니다.",
        steps: [
  ...
  },
  {
    ...
    chatbotSummary: "클래스인은 글로벌 에듀테크 기업 EEO(Empower Education Online, 2014년 설립)의 핵심 제품으로, 화상수업·채팅·클라우드·LMS·녹화·쌍방향 도구를 묶어 온·오프·하이브리드 수업을 운영하는 교육용 SaaS입니다. 한국 학원에서는 전자칠판·녹화·EDB·LMS·관리자 데이터를 한 흐름으로 잇는 수업 시스템 OS로 씁니다. 글로벌 규모 수치는 EEO 공식 소개 기준이며, 국내 도입 기관 수는 상담에서 확인합니다.",
    sections: [
      { heading: "한 줄 소개", body: "클래스인(ClassIn)은 글로벌 에듀테크 기업 EEO(Empower Education Online)가 만든 교육용 SaaS로, 온라인·오프라인·하이브리드 수업을 한 플랫폼에서 운영하도록 돕습니다. 한국 학원에서는 전자칠판·수업 녹화·EDB 교안·LMS·학생 관리·관리자 데이터를 한 흐름으로 묶는 수업 시스템 OS로 설명합니다." },
