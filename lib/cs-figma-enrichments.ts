...
const CURATED_CS_FIGMA_ENRICHMENTS: Record<string, CsFigmaEnrichment> = {
  "cs-figma-digest-1054": {
    title: "수업 후 가입한 학생에게 이전 수업 다시보기 열어주기",
    intro:
      "먼저 학생이 해당 수업이 끝난 뒤 코스에 가입했는지 확인해 주세요. 맞다면 관리자 대시보드에서 신규 참여 학생의 이전 수업 열람을 허용해야 합니다. 이미 코스에 가입한 학생은 설정 후 코스에서 내보낸 뒤 다시 추가해야 반영됩니다.",
    stages: [
      {
        title: "1. 관리자 대시보드 열기",
        body: "ClassIn PC 앱의 프로필 메뉴에서 **관리자용 대시보드**를 엽니다. 대시보드에 직접 로그인해도 됩니다.",
      },
      {
        title: "2. 수업 다시보기 설정으로 이동",
        body: "왼쪽 메뉴에서 **계정 정보 → 일반 설정**으로 이동한 뒤, 상단의 **수업 다시보기** 탭을 선택합니다.",
      },
      {
        title: "3. 정규 학생과 교사의 다시보기 허용",
        body: "먼저 **수업 종료 후 정규 학생과 교사가 수업 다시보기 영상을 시청할 수 있습니다** 옵션을 켭니다. 이 기본 옵션이 꺼져 있으면 신규 참여 학생용 옵션을 켜도 다시보기에 영향을 줄 수 있습니다.",
      },
      {
        title: "4. 신규 참여 학생의 이전 수업 열람 허용",
        body: "**수업 다시보기 권한에 대한 고급 설정**에서 **새로 참여한 학생은 이전 수업 데이터를 볼 수 있습니다** 옵션을 켭니다. 화면 버전에 따라 **코스에 새로 가입된 학생이 이전 수업의 다시보기 시청을 허용합니다**로 표시될 수 있습니다.",
      },
      {
        title: "5. 이미 가입한 학생은 코스에 다시 추가",
        body: "설정을 켜기 전에 이미 코스에 가입한 학생은 변경 내용이 바로 적용되지 않을 수 있습니다. 대상 학생을 코스에서 내보낸 뒤 다시 추가하거나, 학생이 코스에서 나갔다가 다시 입장하도록 안내합니다.",
      },
      {
        title: "6. 학생 화면에서 이전 수업 확인",
        body: "학생 계정으로 코스에 다시 들어가 이전 수업이 목록에 보이고 다시보기를 재생할 수 있는지 확인합니다.",
      },
    ],
    tips: [
      "이 설정은 코스에 새로 참여하는 학생에게 적용됩니다. 이미 참여 중인 학생은 코스 재입장이 필요할 수 있습니다.",
      "설정 활성화 시점에 만들어져 있는 코스 전체에 영향을 줄 수 있으므로 적용 범위를 먼저 확인하세요.",
      "학생의 과거 수업 역할이 변경된 뒤에는 되돌리기 어려울 수 있으므로 대상 학생과 코스를 정확히 확인하세요.",
    ],
  },
  "cs-figma-digest-523": {
