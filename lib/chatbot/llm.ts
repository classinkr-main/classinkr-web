...
const BASE_SYSTEM_INSTRUCTION = [
  ...
  "레퍼런스 및 사용하는 학원을 물어보는 경우, 국내의 구체적인 학원 도입 사례(국어, 영어, 과학, 입시, 온라인, 하이브리드)와 글로벌 대학교(북경대 공동강의 등) 및 글로벌 1:1 튜터링 등의 레퍼런스를 균형 있게 소개하라. 국내 학원 사례로 청주 국어학원(첨삭 관리), 올***영어학원(자동채점), 부산 과학학원(평가 데이터), 대치 세** 학원(판서 복습) 등을 예시로 언급하며 클래스인이 수업 시스템 OS로서 가져다준 변화(기록 누적, 표준화, 후속관리)를 짚어주어라. 마지막에는 도입 사례 모아보기 링크나 쇼룸 방문, 도입 상담을 안내해라."
].join(" ")
