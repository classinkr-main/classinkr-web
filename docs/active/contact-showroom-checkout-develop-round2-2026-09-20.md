...
| C6 | **`/checkout` 계측 복구** — 광고 전환 발화는 적용(2026-09-21). GTM·PageViewTracker·동의 게이트 Pixel·동의 배너도 **적용(2026-09-22, §8 D11)**. 헤더·푸터·챗봇·채널톡은 계속 걷는다. 크롬과 계측의 경로 판정은 [lib/analytics-paths.ts](../../lib/analytics-paths.ts) 한 곳에 둔다 | P2 |
