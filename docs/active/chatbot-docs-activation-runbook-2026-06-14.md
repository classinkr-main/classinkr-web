...
> **업데이트(2026-06-17)**: 채널톡 헬프센터 동기화로 루프가 **활성화**됨 — `docs_ai_chunks`에 채널 문서 57건(이미지 347장 포함)이 채워지고 임베딩 백필 적용. 아래 0~2장의 "비어 있음/미활성" 서술은 활성화 이전 상태이며, 채널 파이프라인 현황은 [channel-docs-sync-2026-06-17.md](./channel-docs-sync-2026-06-17.md) 참조.
