...
기준 시점: 2026-08-29
후속 문서: [컨택 · 쇼룸 예약 · 구매 신청 디벨롭 2차 기획(2026-09-20)](./contact-showroom-checkout-develop-round2-2026-09-20.md) — 이 문서 적용 이후를 실측해 남은 결손과 다음 실행 순서를 정한다. 현재 상태 판단은 2차 문서를 먼저 본다.
