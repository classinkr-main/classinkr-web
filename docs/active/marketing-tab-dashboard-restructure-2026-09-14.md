...
- Compass 브리지·밴드: `lib/compass/bridge.ts`, `lib/compass/home-band.ts`, `components/admin/crm/home/CompassPipelineBand.tsx`, `app/api/admin/crm/compass-pipeline/route.ts`.
