...
export const metadata: Metadata = createPublicMetadata({
  title: "무료 자료",
  description:
    "Classin 도입을 검토하는 학원이 운영 누수, 전자칠판 구축, 비교 도입, ROI, 관리자 데이터, API 자동화 자료를 한곳에서 확인할 수 있는 자료실입니다.",
  path: "/resources",
  keywords: ["Classin 자료", "학원 운영 체크리스트", "전자칠판 체크리스트", "Classin API", "학원 ROI", "도입 가이드"],
})
      ...
      <JsonLd
        data={[
          createWebPageJsonLd({
            ...
            name: "Classin 무료 자료",
            description:
              "Classin 도입을 검토하는 학원이 운영 누수, 교실 구축, 비교 도입, ROI, 관리자 데이터, API 자동화 자료를 확인할 수 있는 자료실입니다.",
          }),
