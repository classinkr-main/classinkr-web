...
export default function CustomersPage() {
  ...
  const filtered = (search
    ...
    const leftNext = left.insight?.next_event_at ? new Date(left.insight.next_event_at).getTime() : Number.POSITIVE_INFINITY
    const rightNext = right.insight?.next_event_at ? new Date(right.insight.next_event_at).getTime() : Number.POSITIVE_INFINITY
              ...
              >
                ...
                <div className="mt-3 grid grid-cols-2 gap-2 text-xs">
                  ...
                  <div className="rounded-lg border border-[#f0f0ec] bg-[#fcfcfb] px-3 py-2">
                    ...
                    <p className="mt-1 font-medium text-[#1a1a1a]">{formatRecentLabel(insight?.recent_activity_at ?? null)}</p>
                    <p className="mt-0.5 text-[11px] text-[#1a1a1a]/45">
