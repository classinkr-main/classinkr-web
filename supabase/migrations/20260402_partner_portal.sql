-- ============================================================
-- ⚠️ 재실행 금지 — 적용 완료된 비멱등 마이그레이션 (2026-07-27 DB 전수 감사)
--
-- CREATE TYPE / CREATE TABLE / CREATE TRIGGER / CREATE POLICY 전부 존재
-- 가드(IF NOT EXISTS)가 없어, 이미 적용된 DB에서 다시 실행하면 첫 줄의
-- CREATE TYPE partner_status 에서 42710(duplicate_object)으로 실패한다.
-- 완전 신규 환경을 처음부터 재현할 때만 실행할 것.
-- ============================================================
