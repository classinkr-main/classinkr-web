...
// 품질 웨이브 4에서 두 항목 모두 정리 완료 — BranchRegionHeatmap.tsx의 rose-* 유출은
// 캐논 Danger hex로(항목 7), BranchPipelineKanban.tsx의 로컬 #7B8B36 재정의는
// lib/branch/team-colors.ts(teamColorOf) 소비로(항목 2) 전환됐다.
